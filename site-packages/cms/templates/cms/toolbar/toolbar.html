    ...
    <div class="cms-toolbar">
        ...
        <div class="cms-toolbar-right">
            {% for item in cms_toolbar.get_right_items %}
                {{ item.render }}
            {% endfor %}
            <div class="cms-toolbar-item cms-toolbar-item-buttons ">        
                <form method='GET'>
                    <a href="{% url 'descargar'  url=request.build_absolute_uri  %}" 
                        class="cms-btn" data-rel="modal"
                        >Descargar</a>
                </form>
            </div>
            <div class="cms-toolbar-item cms-toolbar-item-buttons ">        
                <form method='GET'>
                    <a href="{% url 'manual'  url=request.build_absolute_uri  %}" 
                        class="cms-btn" data-rel="modal"
                        >Manual</a>
                </form>
            </div>
